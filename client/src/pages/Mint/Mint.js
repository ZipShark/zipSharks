...
const purchase = () => {
  ...
  const contractAddress = "0x3600FA0140a3712bFf107Fa0CCB434c632f3F216";
  ...
  return (
    <>
    <MintSection connectWallet={connectWallet} errorMessage={errorMessage} isConnected={isConnected} address={address} />
    {/* {transactionCompleted ? <MintSection connectWallet={connectWallet} errorMessage={errorMessage} address={address}/> : <ThanksSection/>} */}
    </>
  )
}
